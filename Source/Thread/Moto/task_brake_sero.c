...
static uint8_t rail_motor_forward[8] = {0x00, 0x3C, 0x01, 0x90, 0x00, 0x00,0x2E,0xE0};
static uint8_t rail_motor_reverse[8] = {0x00, 0x3C, 0x01, 0x90, 0xFF, 0xFF,0xD1,0x20};
