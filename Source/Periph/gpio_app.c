...
static void GPIOBank0Pin2PinMuxSetup(void);
...
static void GPIOBankPinInterruputInit(void)
{
    ...
    GPIOIntTypeSet(SOC_GPIO_0_REGS, GPIO_UART485_INT, GPIO_INT_TYPE_RISEDGE);
...
static void GPIOBankPinMuxSet(void)
{
    ...
    GPIOBank0Pin2PinMuxSetup();  //uart 485 int
    /* FPGA DONE信号 */
...
static void GPIOBankPinInit(void)
{
    ...
    GPIODirModeSet(SOC_GPIO_0_REGS, GPIO_UART485_INT, GPIO_DIR_INPUT);
